...
class PartialParse(object):
    ...
    def parse(self, transitions):
        """Applies the provided transitions to this PartialPars
...
def minibatch_parse(sentences, model, batch_size):
    ...
    while unfinished_parses:
        ...
        unfinished_parses = [partial_parse for partial_parse in unfinished_parses if not(len(partial_parse.stack)==1 and not partial_parse.buffer)]
